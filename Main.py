...
class Main(QMainWindow, Ui_MainWindow):
    ...
    def video_capturing(self):
        ...
        frame_process = mp.Process(target=capturingVideo.start_video_capturing,args=(Main.FRAME_FROM_CAM,))
        frame_process.start()
        ...
        while True:
            ...
            if Main.FRAME_FROM_CAM.empty():
                continue
            field_frame = Main.FRAME_FROM_CAM.get()
            # field_frame = capturingVideo.start_video_capturing(FRAME_FROM_CAM)
